...
var ChartContainer = (function(_React$Component) {
    ...
    _createClass(ChartContainer, [
        ...
        {
            key: "handlePanZoomEnd",
            value: function handlePanZoomEnd() {
        ...
        },
        {
            ...
            value: function render() {
                    ...
                    if ((0, _reactHotLoader.areComponentsEqual)(child.type, _ChartRow2.default)) {
                        ...
                        var props = {
                            ...
                            onTimeRangeChanged: function onTimeRangeChanged(tr) {
                                return _this3.handleTimeRangeChanged(tr);
                            },
                            onTrackerChanged: function onTrackerChanged(t) {
                                return _this3.handleTrackerChanged(t);
                            }
                        };
                        var _transform =
                ...
                var timeAxisStyle = (0, _merge2.default)(
                    true,
                    ...
                    _react2.default.createElement(
                        _EventHandler2.default,
                        {
                            ...
                            onMouseOut: function onMouseOut(e) {
                                return _this3.handleMouseOut(e);
                            },
                            onMouseMove: function onMouseMove(x, y) {
                                return _this3.handleMouseMove(x, y);
                            },
                            onMouseClick: function onMouseClick(e) {
                                return _this3.handleBackgroundClick(e);
                            },
                            onPanZoomEnd: function onPanZoomEnd(e) {
                                return _this3.handlePanZoomEnd(e);
                            },
                            onZoom: function onZoom(tr) {
                                return _this3.handleZoom(tr);
                            }
                        },
                        chartRows
                    )
...
ChartContainer.propTypes = {
     ...
     */
    onPanZoomEnd: _propTypes2.default.func
};
